...
import com.container.pages.OrderPage;
...
public class OrderTest extends BaseTest {
	...
	public void googleTest(String category) {
		...
		itemPrice.stream().forEach(System.out::println);
		System.out.println("----------------------------");
	...
	public static Object[][] credentials() {
		return new Object[][] { { "Accessories" }, { "iMacs" }, { "iPads" }, { "iPhones" }, { "iPods" }, { "MacBooks" },
				{ "Accessories" }, { "iMacs" }, { "iPads" }, { "iPhones" }, { "iPods" }, { "MacBooks" } };
	}
